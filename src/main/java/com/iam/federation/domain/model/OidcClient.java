...
/**
 * OIDC Relying Party registered with Explore IAM (maps to Spring Authorization Server
 * {@code RegisteredClient}).
 */
public class OidcClient {
    ...
    private OidcClient(
        ...
        this.postLogoutRedirectUris = copyUris(
                postLogoutRedirectUris == null ? Set.of() : postLogoutRedirectUris, "postLogoutRedirectUris");
        this.scopes = copyStrings(scopes, "scopes");
        this.responseTypes = copyStrings(responseTypes, "responseTypes");
        this.clientAuthenticationMethods = copyStrings(clientAuthenticationMethods, "clientAuthenticationMethods");
    ...
    public static OidcClient register(
            ...
            Set<String> clientAuthenticationMethods,
            Set<String> authorizationGrantTypes) {
        ClientId clientId = new ClientId("app-" + UUID.randomUUID().toString().replace("-", "").substring(0, 16));
