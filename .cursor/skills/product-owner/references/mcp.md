...
| `FVXI` | 支持 | Service Request, Incident, 任务, 子任务 |
...
```json
{
  ...
  "arguments": {
    ...
    "description": "Background, User Story, Acceptance Criteria, Definition of Done",
...
2. Use `createJiraIssue` to create a story or task (use `EXP` for Explore IAM / Explore product work)
...
4. For `projectKey`, use `EXP` for Explore (Explore IAM) work
